...
点击 **申请开通**。页面会显示“申请已发送，等待管理员同意”。这一步不需要填写地址、密码或 Token。

管理员同意后，搭手会自动准备连接。回到搭手，点击 **添加文件夹**，可以连续添加多个你希望 ChatGPT 使用的工作文件夹，然后点击 **开始使用**。

![搭手首次设置：申请开通并添加文件夹](images/first-setup.jpg)
...
如果申请没有成功，页面会直接显示原因。点击旁边的 **复制排查信息**，把复制的内容发给客服即可；也可以附上页面截图。不要发送连接密码、Tunnel Token 或本机日志中的敏感内容。
