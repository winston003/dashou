...
export function createDashouMcpServer(workspaceRegistry: DashouWorkspaceRegistry, observer?: ToolCallObserver): McpServer {
  ...
  app.all("/mcp", async (req, res) => {
    ...
    try {
      ...
      if (sessionId) {
        ...
        const mcpServer = createDashouMcpServer(workspaces, observeToolCall);
